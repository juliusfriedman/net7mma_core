...
namespace Media.Http
{
    ...
    public class HttpClient : Common.SuppressedFinalizerDisposable, Common.ISocketReference
    {
                ...
                Connect:
                    ...
                    if (Strict)
                    {
                        ...
                        if (1.1 >= message.Version && false == message.ContainsHeader(HttpHeaders.Host)) //Should remove host header if present?
                        {
                            ...
                            //Should be on it's own code path... we just checked for 1.1 and lack of the host header.
                        ...
                        //Check for Accept / Accept Encoding conflicts etc.
        ...
        //Todo, doesn't have to be virtual, use delegation or have a table of authenticators...
