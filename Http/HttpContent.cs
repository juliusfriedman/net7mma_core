...
namespace Media.Http
{
    ...
    public class BinaryContent : HttpContent
    {
        ...
        {
            if (data is null || data.Count == 0) throw new ArgumentException("data cannot be null or empty");
    ...
    public class MultipartContent : HttpContent, IEnumerable<HttpContent>
    {
        ...
        {
            if (boundary is null || boundary.Count == 0) throw new ArgumentException("boundary cannot be null or empty");
