...
namespace Media.Http
{
    ...
    public class HttpMessage : Common.SuppressedFinalizerDisposable, Common.IPacket
    {
        ...
        {
            if (false.Equals(m_Buffer is null) && m_Buffer.CanWrite) m_Buffer.Dispose();
        ...
        virtual protected bool ParseHeaders(bool force = false)
        {
            try
            {
                ...
                if (object.ReferenceEquals(m_Buffer, null) || m_Buffer.CanSeek is false) return false;
                ...
                if(object.ReferenceEquals(m_Buffer, null) is false && m_Buffer.CanSeek) m_Buffer.Seek(position, System.IO.SeekOrigin.Begin);
            ...
            try
            {
                        ...
                        (remains = max - position) > 0)
                {
                    ...
                    if (string.IsNullOrWhiteSpace(rawLine))
                    {
                        ...
                        //Stop parsing when an exception occurs (even if more data remains)
                        if (object.ReferenceEquals(encountered, null) is false) break;
        ...
        internal protected virtual Encoding ParseContentEncoding(bool force = false, bool raiseWhenNotFound = false)
        {
            ...
            if (force is false && false.Equals(m_ContentDecoder is null)) return m_ContentDecoder;
        ...
        internal protected virtual bool ParseBody(out int remaining, bool force = false) //bool requireContentLength = true
        {
            ...
            if (m_Buffer is null || false.Equals(m_Buffer.CanRead)) return false;
        ...
        public virtual string ToEncodedString()
        {
            ...
            if(object.ReferenceEquals(HeaderEncoding, null) is false) try
            {
        ...
        public virtual void AppendOrSetHeader(string name, string value) //string joiner
        {
            ...
            if (ContainsHeader(name, out containedHeader) is false) SetHeader(name, value); //joiner ?? 
        ...
        public virtual void AppendOrSetEntityHeader(string name, string value) //string joiner
        {
            ...
            //If not already contained then set, otherwise append the value given
            if (ContainsEntityHeader(name, out containedHeader) is false) SetEntityHeader(name, value); //joiner ?? 
            else if (nullValue is false)
            {
                string containedValue = m_Headers[containedHeader];
        ...
        internal bool ContainsHeader(string name, out string headerName)
        {
            ...
            return false == object.ReferenceEquals(headerName, null);// is false;
        }
        ...
        internal bool ContainsEntityHeader(string name, out string headerName)
        {
            ...
            //The name was contained if name is not null
            return object.ReferenceEquals(headerName, null) is false;
        }
        ...
        public virtual IEnumerable<byte> PrepareStatusLine(bool includeEmptyLine = true, bool escapeUri = true, Encoding uriEncoding = null)
        {
            ...
            if (MessageType == HttpMessageType.Request || MessageType == HttpMessageType.Invalid)
            {
                ...
                string uri = object.ReferenceEquals(Location, null) ? HttpMessage.Wildcard.ToString() : Location.OriginalString;
            ...
            if (includeEmptyLine && object.ReferenceEquals(m_EncodedLineEnds, null) is false) sequence = Enumerable.Concat(sequence, headerEncoding.GetBytes(m_EncodedLineEnds));
        ...
        public virtual IEnumerable<byte> PrepareHeaders(bool includeEmptyLine = true)
        {
            ...
            if (includeEmptyLine && object.ReferenceEquals(m_EncodedLineEnds, null) is false) sequence = Enumerable.Concat(sequence, m_HeaderEncoding.GetBytes(m_EncodedLineEnds)); //foreach (byte b in m_HeaderEncoding.GetBytes(m_EncodedLineEnds)) yield return b;
        ...
        public virtual IEnumerable<byte> PrepareBody(bool includeEmptyLine = false)
        {
            ...
            if (includeEmptyLine && object.ReferenceEquals(m_EncodedLineEnds, null) is false) sequence = Enumerable.Concat(sequence, ContentEncoding.GetBytes(m_EncodedLineEnds));  //foreach (byte b in m_HeaderEncoding.GetBytes(m_EncodedLineEnds)) yield return b;
        ...
        public virtual int CompleteFrom(System.Net.Sockets.Socket socket, Common.MemorySegment buffer)
        {
            ...
            bool hasSocket = object.ReferenceEquals(socket, null) is false,
        ...
        //Top:
            ...
            //If it was not present then do not parse further
            if ((sawDelemit = Media.Common.Extensions.Encoding.EncodingExtensions.ReadDelimitedDataFrom(HeaderEncoding, m_Buffer, m_EncodedLineEnds, length, out ChunkLine, out read, true)) is false)
            {
                return -1;
            }
