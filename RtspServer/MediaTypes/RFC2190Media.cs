...
namespace Media.Rtsp.Server.MediaTypes
{
    ...
    public class RFC2190Media : RFC2435Media //RtpSink
    {
        ...
        public override void Start()
        {
            ...
            SessionDescription.Add(new Sdp.MediaDescription(Sdp.MediaType.video, Rtp.RtpClient.RtpAvpProfileIdentifier, RFC2190Frame.RtpH323PayloadType, 0));
            ...
            RtpClient.TryAddContext(new Rtp.RtpClient.TransportContext(0, 1, SourceId, SessionDescription.MediaDescriptions.First(), false, 0));
        }
