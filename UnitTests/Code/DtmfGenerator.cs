...
public static class DtmfGenerator
{
    ...
    public readonly struct Config : IEquatable<Config>
    {
        ...
        public static readonly Config Default = new(DefaultThreshold, DefaultSampleBlockSize, DefaultSampleRate, normalizeResponse: true);
        ...
        public Config WithThreshold(double threshold) => new(threshold, SampleBlockSize, SampleRate, NormalizeResponse);
        ...
        public Config WithSampleBlockSize(int sampleBlockSize) => new(Threshold, sampleBlockSize, SampleRate, NormalizeResponse);
        ...
        public Config WithSampleRate(int sampleRate) => new(Threshold, SampleBlockSize, sampleRate, NormalizeResponse);
        ...
        public Config WithNormalizeResponse(bool normalizeResponse) => new(Threshold, SampleBlockSize, SampleRate, normalizeResponse);
